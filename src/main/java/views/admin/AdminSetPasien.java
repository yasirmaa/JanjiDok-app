...
public class AdminSetPasien extends javax.swing.JPanel {
    ...
    public void getPasienFromTable() {
        int selectedRow = tabelPasien.getSelectedRow();

        String fullName = tabelPasien.getValueAt(selectedRow, 1).toString();
        String noTelp = tabelPasien.getValueAt(selectedRow, 2).toString();
        String username = tabelPasien.getValueAt(selectedRow, 3).toString();
        String password = tabelPasien.getValueAt(selectedRow, 4).toString();
...
//    private Pasien findPasien(String username, String password) {
//        for (Pasien user : app.getRS().getAllPasien()) {
